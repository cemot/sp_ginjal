			  ...
			  <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-plus"></i>Rule Nilai DS</li>						  	
					</ol>
				</div>
			</div>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" action="<?php echo site_url()?>/ruleds/create" method="POST">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <select class="form-control" name="id_penyakit" id="id_penyakit">
                                                <option value="NULL">Pilih Jenis Penyaki</option>
